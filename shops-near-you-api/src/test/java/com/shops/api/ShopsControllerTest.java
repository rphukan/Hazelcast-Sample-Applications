...
public class ShopsControllerTest {
	...
	public void updateShop() throws Exception {
		Shop shop = new Shop();
		shop.setName("Grocery Store");
		Address address = new Address();
		address.setNumber("1600");
		address.setLine1("Amphitheatre Parkway");
		address.setLine2("Mountain View, CA");
	...
	public void getShop() throws Exception {
		...
		Assert.assertNotNull("Should return a Shop with address.", response.getBody().getAddress().getLine1());
	}
}
